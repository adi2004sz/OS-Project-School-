...
test_setup: all
	...
	@mkdir -p $(TEST_HUNT)
	./treasure_manager add $(TEST_HUNT) 1 alexia 37.7749 -122.4194 "Under the red bridge" 100
	./treasure_manager add $(TEST_HUNT) 2 bob 40.7128 -74.0060 "Near the tall tower" 200
	./treasure_manager add $(TEST_HUNT) 3 alexia 34.0522 -118.2437 "Behind the palm tree" 150
...
test_advanced: all clean_test_data
	...
	@mkdir -p hunt1
	@mkdir -p hunt2
	./treasure_manager add hunt1 1 claudiu 51.5074 -0.1278 "Under the clock tower" 300
	...
	./treasure_manager add hunt2 2 fabian 22.3193 114.1694 "Under the bridge" 350
